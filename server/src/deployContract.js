...
async function testBlockchain() {
  ...
  transition Allowance (tokenOwner : ByStr20, spender : ByStr20)
    ...
    const [xfer1, xfer2, xfer3] = await Promise.all([
      hello.call(
        'Transfer',
        [
          { vname: 'to', type: 'ByStr20', value: 'f6dad9e193fa2959a849b81caf9cb6ecde466771' },
      ...
      hello.call(
        'Transfer',
        [
          { vname: 'to', type: 'ByStr20', value: '381f4008505e940ad7681ec3468a719060caf796' },
      ...
      hello.call(
        'Transfer',
        [
          { vname: 'to', type: 'ByStr20', value: 'b028055ea3bc78d759d10663da40d171dec992aa' },
          { vname: 'tokens', type: 'Uint128', value: '998' },
        ],
        {
          version: VERSION,
          pubKey: publicKey,
...
testBlockchain();
  ...
  //     value: `0x${address}`
  //   },
  //   { type: 'Uint128', value: '1999999', vname: 'total_tokens' },
  //   { type: 'Uint32', value: '12', vname: 'decimals' },
  //   { type: 'String', value: 'BobCoin', vname: 'name' },
  //   { type: 'String', value: 'BOB', vname: 'symbol' }
  // ];

     //   // const contracts = await zilliqa.blockchain.getSmartContractInit(
    //   //   "ce22fa78aeaa326029c04eec985fe890125ba9b6"
    //   // )

    //   // "ddcc2db3a7781300b769eb384b7fb255db2e1451"
    ...
    //   const [deployTx, bobCoin] = await contract.deploy({
    //     version: VERSION,
    //     gasPrice: myGasPrice,
    ...
    //   // Get the contract state
    //   const state = await bobCoin.getState();
    //   console.log("The state of the contract is:");
    //   console.log(state);
